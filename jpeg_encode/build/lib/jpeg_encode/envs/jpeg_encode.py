...
class JPEGEncode(gym.Env):
    ...
    def reset(
        ...
        *,
        ...
        # self.stacked_img = torch.stack([self.img, self.img, self.img], dim=0)
    ...
    def step(self, action):
        ...
        encoded = simplejpeg.encode_jpeg(jpeg_enc, 85, colorsubsampling='422')
        enc_end = (time.time())
        print(enc_end)
        ...
        return self.img, reward, done, False, {}
